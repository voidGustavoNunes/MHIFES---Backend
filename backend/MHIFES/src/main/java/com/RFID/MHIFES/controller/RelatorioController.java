...
public class RelatorioController {
	...
	public ResponseEntity<String> gerarRelatorioDisciplinaTurma(@PathVariable Integer ano,
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
					.body("Ocorreu um erro ao gerar o relatório.");
		}
	}
	...
	public ResponseEntity<String> gerarRelatorioHorarioPorProfessor(
